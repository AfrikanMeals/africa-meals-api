...
import { PlatformAnalyticsSettingsModule } from './modules/platform-analytics-settings/platform-analytics-settings.module';
...
@Module({
  imports: [
    ...
    // GraphQL `/api/graphql` : Mercurius (Fastify local/PM2) ou Apollo (Express / Functions).
    GraphqlApiModule,
    ...
    PlatformAnalyticsSettingsModule,
    PosSettingsModule,
    BusinessTypesModule,
    AdsTargetingModule,
